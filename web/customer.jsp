                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i> Customer Management
                            </div>
                            <div class="card-body">
                                        ...
                                        <c:forEach var="customer" items="${customers}">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="setDeleteUser(${customer.customerId}, '${customer.fullName}')">
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
