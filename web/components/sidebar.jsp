            ...
            <div class="nav">
                ...
                <div class="collapse" id="personnelCollapse" aria-labelledby="headingPersonnel" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="admin">Owner Management</a>
                        <a class="nav-link" href="owner">Staff Management</a>
                ...
                <div class="collapse" id="warehouseCollapse" aria-labelledby="headingWarehouse" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="warehouserice">Warehouse Rice</a>
                        <a class="nav-link" href="RiceController">Rice Inventory</a>
                    </nav>
                </div>
